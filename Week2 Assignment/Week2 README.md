...
# ANSWER: I used a dataset of 377 business accounts, each with information such as company size, industry, revenue, 
#product usage, support tickets, and whether they eventually upgraded. 
#After cleaning, I removed 7 duplicate rows and handled missing values in several columns. 
# I ended up with 370 rows and 13 columns. \n    Originally the target had 293 -No- and 84 -Yes-.
...
# Numerical Features: Annual_Revenue, Monthly_Transactions, Account_Age_Months, Support_Tickets, 
# Product_Usage_Score, Monthly_Fee.
